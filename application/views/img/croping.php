 ...
 <div class="pg-header-row" style="width: 1000px !important;">
  <div class="card col-md-4 p-3" style="margin-left: -30px!important;width: 300px !important;">
   <div class="containerdd mt-5">
    <form action="<?php echo base_url(); ?>images/cropingPost" method="post"  enctype="multipart/form-data" class="mb-3">
      <h6 class="text-center mb-5">Croping</h6>
            ...
            <?php foreach ($images as $key => $image) { ?>
              <tr>
                <td><img src="<?= base_url($image['image_url']);?>" alt="Generated Image" style="width:100px;height: 80px;"></td>
                              <td>
                  <a href="<?= base_url('download/image/'.$image['id'].'/croping'); ?>" class="btn btn-primary p-2">Download</a>
                  <a href="<?= base_url('delete/image/'.$image['id'].'/croping'); ?>" class="btn btn-danger p-2">Delete</a>
                </td>
              </tr>
