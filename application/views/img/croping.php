<h3 class="text-center mb-4 font">Croping</h3>
 ...
 <div class="pg-header-row" style="width: 100% !important;">
  <div class="card col-md-4 p-3 imgviews" >
   <div class="containerdd mt-5" style="max-width:100%;">
    <form action="<?php echo base_url(); ?>images/cropingPost" method="post"  enctype="multipart/form-data" class="mb-3 imgform">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="vertical-align:middle;text-align:center;">
                  <a href="<?= base_url('download/image/'.$image['id'].'/croping'); ?>" title="Download"  style="color:black;"><i    class="fa fa-download" style="font-size: 35px;"></i></a>
                  <a href="<?= base_url('delete/image/'.$image['id'].'/croping'); ?>" title="Delete"  style="color:red;"><i class="fa fa-trash" style="font-size: 35px;margin-left:15px"></i></a>
                </td>
              </tr>
